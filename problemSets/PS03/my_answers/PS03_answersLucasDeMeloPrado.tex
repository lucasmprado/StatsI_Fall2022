...
\begin{enumerate}
	\item \textbf{Run a regression where the outcome variable is \texttt{voteshare} and the explanatory variable is \texttt{difflog}.}
		...
		\lstinputlisting[language=R, firstline=21, lastline=26]{PS03_answersLucasDeMeloPrado.R}		
	...
	\item \textbf{Make a scatterplot of the two variables and add the regression line.}
		...
		\lstinputlisting[language=R, firstline=29, lastline=37]{PS03_answersLucasDeMeloPrado.R}
		
		\begin{figure}[H]
			\centering
			\caption{The effect of the difference in campaign spending between incumbent and challenger on the incumbent's vote share}
			\label{fig:lm_q1}
	...
	\item \textbf{Save the residuals of the model in a separate object.}
		...
		\lstinputlisting[language=R, firstline=40, lastline=40]{PS03_answersLucasDeMeloPrado.R}
...
\begin{enumerate}
	\item \textbf{Run a regression where the outcome variable is \texttt{presvote} and the explanatory variable is \texttt{difflog}.}
		...
		\lstinputlisting[language=R, firstline=47, lastline=54]{PS03_answersLucasDeMeloPrado.R}
	...
	\item \textbf{Make a scatterplot of the two variables and add the regression line.}
		...
		\lstinputlisting[language=R, firstline=57, lastline=65]{PS03_answersLucasDeMeloPrado.R}

		\begin{figure}[H]
			\centering
			\caption{The effect of the difference between incumbent's and challenger's spending on the vote share of the presidential candidate of the incumbent's party}
			\label{fig:lm_q2}
	...
	\item \textbf{Save the residuals of the model in a separate object.}
		...
		\lstinputlisting[language=R, firstline=68, lastline=68]{PS03_answersLucasDeMeloPrado.R}
...
\begin{enumerate}
	\item \textbf{Run a regression where the outcome variable is \texttt{voteshare} and the explanatory variable is \texttt{presvote}.}
		...
		\lstinputlisting[language=R, firstline=75, lastline=82]{PS03_answersLucasDeMeloPrado.R}
	...
	\item \textbf{Make a scatterplot of the two variables and add the regression line.}
		...
		\lstinputlisting[language=R, firstline=85, lastline=93]{PS03_answersLucasDeMeloPrado.R}
...
\begin{enumerate}
	\item \textbf{Run a regression where the outcome variable is the residuals from Question 1 and the explanatory variable is the residuals from Question 2.}
		...
		\lstinputlisting[language=R, firstline=101, lastline=106]{PS03_answersLucasDeMeloPrado.R}
	...
	\item \textbf{Make a scatterplot of the two residuals and add the regression line.}
		...
		\lstinputlisting[language=R, firstline=109, lastline=117]{PS03_answersLucasDeMeloPrado.R}	
...
\begin{enumerate}
	\item \textbf{Run a regression where the outcome variable is the incumbent's \texttt{voteshare} and the explanatory variables are \texttt{difflog} and \texttt{presvote}.}
		...
		\lstinputlisting[language=R, firstline=125, lastline=133]{PS03_answersLucasDeMeloPrado.R}
